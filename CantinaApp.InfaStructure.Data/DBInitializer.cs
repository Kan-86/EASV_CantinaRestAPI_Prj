...
namespace CantinaApp.InfaStructure.Data
{
    public class DBInitializer
    {
        ...
        public static void SeedDb(CantinaAppContext ctx)
        {
            ...
            byte[] passwordHashKris, passwordSaltKris, passwordHashJacob, passwordSaltJacob;
            CreatePasswordHash(password, out passwordHashKris, out passwordSaltKris);
            CreatePasswordHash(password, out passwordHashJacob, out passwordSaltJacob);

            List<Users> users = new List<Users>
            {
                new Users {
                    Username = "kris",
                    PasswordHash = passwordHashKris,
                    PasswordSalt = passwordSaltKris,
                    IsAdmin = true
                },
                new Users {
                    Username = "jacob",
                    PasswordHash = passwordHashJacob,
                    PasswordSalt = passwordSaltJacob,
                    IsAdmin = false
                }
            };
